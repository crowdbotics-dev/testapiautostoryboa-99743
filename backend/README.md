...
## Project Structure
    ...
    ├── testapiautostoryboa_99743  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_99743`
...
2. Clone this repo and `cd testapiautostoryboa_99743`
